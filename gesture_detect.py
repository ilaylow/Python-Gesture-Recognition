...
model = tf.keras.models.load_model(r"C:\Users\chuen\Desktop\Python\image_recognition_basics\64x2-CNN-GestureRecog.model")
...
predict = model.predict([prepare(r"C:\Users\chuen\Desktop\Python\image_recognition_basics\Python-Gesture-Recognition\test_images\okay_test.jpg")])
...
"""while True:
    ...
    img_index = int(max(predict[0]))
    print(predict)
    print(img_index)
    print(IMAGE_TYPES[img_index])
    cv2.putText(roi, IMAGE_TYPES[img_index], (100, 100), font, 0.5, (255, 255, 255), 5, cv2.LINE_AA)
